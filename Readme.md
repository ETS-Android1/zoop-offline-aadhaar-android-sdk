...
### USING GRADLE
   ...
   Implement below line in your build.gradle file at app level under dependency section
    ...
    implementation 'sdk.zoop.one.offline_aadhaar:offline_aadhaar:1.0.7'
...
### 5.2 BUILD GRADLE(app)
    ...
    dependencies {
        ...
        implementation 'sdk.zoop.one.offline_aadhaar:offline_aadhaar:1.0.7'// only if you are using gradle dependency in this 
       // implementation project(':offline_aadhaar-releaseV1.0.7')// only if you are using AAR file then
